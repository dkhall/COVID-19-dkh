...
ax.annotate('China: {:,}'.format(cases_cn[-1]), (dates[-1]+dt.timedelta(days=1), 1.25*cases_cn[-1]), color='red', fontsize=9)
...
ax.annotate('US: {:,}'.format(cases_us[-1]), (dates[-1]+dt.timedelta(days=1), 0.6*cases_us[-1]), color='blue', fontsize=9)
